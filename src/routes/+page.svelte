...
<div class="flex min-h-screen flex-col items-center justify-center gap-6 px-4 py-12">
  ...
  <!-- Latest Posts -->
  {#if posts.length > 0}
    <section class="w-full max-w-2xl mx-auto mo-fade-in-up" use:fadeInUp={{ delay: 0.2 }}>
      <h2 class="text-lg font-semibold mb-4 text-muted-foreground">最新</h2>
      <div class="space-y-3">
  ...
  <!-- Tags -->
  {#if allTags.length > 0}
    <section class="w-full max-w-2xl mx-auto mo-fade-in-up" use:fadeInUp={{ delay: 0.25 }}>
      <h2 class="text-lg font-semibold mb-4 text-muted-foreground">标签</h2>
  ...
  <!-- Navigation -->
  <section class="w-full max-w-2xl mx-auto mo-fade-in-up" use:fadeInUp={{ delay: 0.3 }}>
    <h2 class="text-lg font-semibold mb-4 text-muted-foreground">导航</h2>
  ...
  <!-- Social Links -->
  <section class="w-full max-w-2xl mx-auto mo-fade-in-up" use:fadeInUp={{ delay: 0.35 }}>
    <h2 class="text-lg font-semibold mb-4 text-muted-foreground">社交</h2>
    <div class="flex flex-wrap gap-3 justify-center">
